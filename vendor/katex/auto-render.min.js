    ...
    return (
      (() => {
        ...
        var a = (e, t) => {
          ...
          const o = [],
            a = new RegExp(
              '(' + t.map((e) => e.left.replace(/[-/\\^$*+?.()|[\]{}]/g, '\\$&')).join('|') + ')',
            );
          while (((r = e.search(a)), -1 !== r)) {
            r > 0 && (o.push({ type: 'text', data: e.slice(0, r) }), (e = e.slice(r)));
            ...
            o.push({ type: 'math', data: s, rawData: l, display: t[a].display }),
            ...
            for (let e = 0; e < r.length; e++)
              if ('text' === r[e].type) o.appendChild(document.createTextNode(r[e].data));
                ...
                try {
                  ...
                  n.errorCallback(
                    'KaTeX auto-render: Failed to parse `' + r[e].data + '` with ',
                    i,
                  ),
            ...
            for (let n = 0; n < e.childNodes.length; n++) {
              ...
              if (3 === r.nodeType) {
                ...
                -1 === t.ignoredTags.indexOf(r.nodeName.toLowerCase()) &&
                  t.ignoredClasses.every((t) => -1 === e.indexOf(' ' + t + ' ')) &&
                  s(r, t);
              }
            }
          };
