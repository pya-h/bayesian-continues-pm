...
| [v2/TDD.md](v2/TDD.md) | **V2 engineering design** — multi-modal beliefs, adaptive params, hedging, robust oracles/disputes, scale. **(Stays 1× cash-collateralized.)** |
...
| [v3/TASKS.md](v3/TASKS.md) | **V3 phased build plan** (Phases V3-1 … V3-5). Prereq: V1 + V2 shipped. |
